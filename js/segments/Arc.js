...
define( function( require ) {
  ...
  Segment.Arc.prototype = {
    ...
    strokeLeft: function( lineWidth ) {
      return [ new Piece.Arc( this.center, this.radius - lineWidth / 2, this.startAngle, this.endAngle, this.anticlockwise ) ];
    },
    
    strokeRight: function( lineWidth ) {
      return [ new Piece.Arc( this.center, this.radius + lineWidth / 2, this.endAngle, this.startAngle, !this.anticlockwise ) ];
    },
