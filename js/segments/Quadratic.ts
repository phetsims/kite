...
export default class Quadratic extends Segment {
  ...
  public curvatureAt( t: number ): number {
    ...
    // TODO: remove code duplication with Cubic https://github.com/phetsims/tasks/issues/1129
  ...
  public getInteriorExtremaTs(): number[] {
    // TODO: we assume here we are reduce, so that a criticalX doesn't equal a criticalY? https://github.com/phetsims/tasks/issues/1129
    const result = [];
